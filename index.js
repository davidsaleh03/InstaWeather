...
function searchHTML(temperature) {
  return `<div class="temperature__module module">
                ...
                <div class="temp__top">
                    <img src="${
                      temperature.current.condition.icon
                    }" alt="" class="fa-cloud-sun">
                    <span class="temp__actual">${
                      temperature.current.temp_c
                    }°C</span>
                </div>
                <div class="temp__descrip">${
                  temperature.current.condition.text
                }</div>
            </div>
            <div class="module__bg"></div>
            <div class="module__more--temp">
                <div class="temp__more">
                    <div class="temp__more--item">Feels Like :  ${
                      temperature.current.feelslike_c
                    }°C</div>
                    <div class="temp__more--item">
                            <span class="temp__more-text">Humidity : ${
                              temperature.current.humidity
                            }</span>
                    </div>
                    <div class="temp__more--item">
                        <span class="temp__more-text">Precipitation : ${
                          temperature.forecast.forecastday[0].day[
                            "daily_chance_of_rain"
                          ]
                        }%</span>
                    </div>
                    <div class="temp__more--item">Wind : 4kph</div>
                    <div class="temp__more--item">Visibility : ${
                      temperature.current.vis_km
                    } km</div>
                    <div class="temp__more--item">UV : ${
                      temperature.current.uv
                    }</div>
                </div>
            </div>
                </div>
            ...
            <ul class="quality__list">
                <li class="quality__item">CO : ${
                  temperature.current.air_quality.co
                }</li>
                <li class="quality__item">NO2 : ${
                  temperature.current.air_quality.no2
                }</li>
                <li class="quality__item">O3 : ${
                  temperature.current.air_quality.o3
                }</li>
            </ul>
        </div>
        <div class="module__bg"></div>
        <div class="module__more--quality">
            <div class="quality__more">
                <div class="quality__more--item">US EPA Index : ${
                  temperature.current.air_quality["us-epa-index"]
                }</div>
                <div class="quality__more--item">GB Defra Index : ${
                  temperature.current.air_quality["gb-defra-index"]
                }</div>
                <div class="quality__more--item">SO2 : ${
                  temperature.current.air_quality.so2
                }</div>              
                <div class="quality__more--item">PM 2.5 : ${
                  temperature.current.air_quality.pm2_5
                }</div>
                <div class="quality__more--item">PM 10 : ${
                  temperature.current.air_quality.pm10
                }</div>
            </div>
        </div>
                </div>
                <div class="alert__module">
                    ...
                    <div class="alert">
                        <h1 class="alert__text">${alertMod(
                          currentWeather.alerts.alert[0]
                        )}</h1>
                    </div>
                </div>
                    ...
                    <ul class="forecast__list">
                        <li class="forecast__day">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[1].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[1].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[1].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                                    <i class="fa-solid fa-droplet"></i>
                                    <span class="humidity__num">${
                                      temperature.forecast.forecastday[1].day
                                        .avghumidity
                                    }</span>
                                </div>
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[1].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[1].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                  currentWeather.forecast.forecastday[1].day[
                                    "air_quality"
                                  ].no2
                                )}</div>
                                <div class="forecast__item--zoom two zoom__margin--more">O3 : ${qualityData(
                                  currentWeather.forecast.forecastday[1].day[
                                    "air_quality"
                                  ].o3
                                )}</div>
                                <div class="forecast__item--zoom rise__zoom">
                                    ...
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[1].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                        ...
                        <li class="forecast__day">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[2].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[2].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[2].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[2].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[2].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                ...
                                <div class="forecast__item--zoom rise__zoom">
                                    <img src="./assets/sunrise.png" class="forecast__rise-set">
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[2].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                        ...
                        <li class="forecast__day">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[3].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[3].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[3].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[3].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[3].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                ...
                                <div class="forecast__item--zoom rise__zoom">
                                    <img src="./assets/sunrise.png" class="forecast__rise-set">
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[3].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                        ...
                        <li class="forecast__day">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[4].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[4].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[4].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[4].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[4].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                ...
                                <div class="forecast__item--zoom rise__zoom">
                                    <img src="./assets/sunrise.png" class="forecast__rise-set">
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[4].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                        ...
                        <li class="forecast__day">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[5].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[5].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[5].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[5].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[5].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                ...
                                <div class="forecast__item--zoom rise__zoom">
                                    <img src="./assets/sunrise.png" class="forecast__rise-set">
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[5].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                        ...
                        <li class="forecast__day one">
                            <div class="forecast__list--small">
                                <div class="forecast__date zoom__margin">${temperature.forecast.forecastday[6].date.slice(
                                  5,
                                  10
                                )}</div>
                                <div class="forecast__temp">
                                    <img src="${
                                      temperature.forecast.forecastday[6].day
                                        .condition.icon
                                    }" alt="" class="fa-sun">
                                    <div class="max-temp">
                                    ${
    ...
    temperature.forecast.forecastday[6].day["mintemp_c"]
  }°C
                                    </div>
                                </div>
                                <div class="humidity">
                            ...
                            <div class="forecast__list--zoom">
                                <div class="forecast__item--zoom two">UV : ${
                                  temperature.forecast.forecastday[6].day.uv
                                }</div>
                                <div class="forecast__item--zoom two">CO : ${qualityData(
                                  currentWeather.forecast.forecastday[6].day[
                                    "air_quality"
                                  ].co
                                )}</div>
                                <div class="forecast__item--zoom two">NO2 : ${qualityData(
                                ...
                                <div class="forecast__item--zoom rise__zoom">
                                    <img src="./assets/sunrise.png" class="forecast__rise-set">
                                    <div class="forecast-rise__time">0${temperature.forecast.forecastday[6].astro.sunrise.slice(
                                      1,
                                      5
                                    )}</div>
                                </div>
                    ...
                    <div class="module__more--time">
                        <div class="time__more">
                            <div class="time__more--item">
                                ...
                                <span class="time__more--text"> : ${
                                  temperature.forecast.forecastday[0].astro
                                    .sunrise
                                }</span>
                                </div>
                            <div class="time__more--item">
  ...
  if (value === "C") {
    ...
    for (let i = 1; i <= 6; ++i) {
      const maxTemp = document.querySelector(
        `.forecast__day:nth-child(${i}) .max-temp`
      );
